<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Perfectionism &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
		...
		&larr; Back to Perfectionism		</a></p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/Perfectionism\/wp-admin\/admin-ajax.php"}};
</script>
...
( function( domain, translations ) {
	...
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2020-09-02 06:42:25+0000","generator":"GlotPress\/3.0.0-alpha.2","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=2; plural=n != 1;","lang":"en_CA"},"Your new password has not been saved.":["Your new password has not been saved."],"Show":["Show"],"Hide":["Hide"],"Confirm use of weak password":["Confirm use of weak password"],"Hide password":["Hide password"],"Show password":["Show password"]}},"comment":{"reference":"wp-admin\/js\/user-profile.js"}} );
</script>
